...
namespace DIRemould_NamedService
{
    ...
    internal sealed class NamedType : TypeDelegator, IServiceProvider
    {
        ...
        /// <returns></returns>
        public static NamedType Get(string name, Type serviceType = null) => _cache.GetOrAdd((name, serviceType), x => new NamedType(x.Item1, x.Item2));
        ...
        /// <param name="serviceType">服务类型</param>
        private NamedType(string name, Type serviceType) : base(typeof(object))
        {
            Name = name;
